...
Generated by TuneMyCV
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow hover:border-zapier-orange/50 relative group">
          ...
          <div className="flex items-center space-x-3 mb-1">
            ...
            {onEditTitle && (
              <button
                ...
                className="opacity-0 group-hover:opacity-100 text-slate-400 hover:text-zapier-orange transition-all duration-200"
                title="Edit title"
              >
