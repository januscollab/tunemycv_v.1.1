    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow hover:border-zapier-orange/50 relative">
      ...
      <div className="flex items-center justify-between mt-3 pt-2 border-t border-slate-100">
        <div className="flex items-center space-x-3">
          <button
            onClick={handleView}
            className="flex items-center px-2 py-1 text-xs text-slate-900 hover:text-zapier-orange transition-colors"
          >
          ...
          <button
            ...
            className={`flex items-center px-2 py-1 text-xs rounded-md transition-colors ${
              analysis.has_cover_letter
                ...
                : 'text-slate-900 hover:text-zapier-orange hover:bg-zapier-orange/10'
            }`}
          >
          ...
          <button
            ...
            className="flex items-center px-2 py-1 text-xs text-slate-900 hover:text-zapier-orange hover:bg-zapier-orange/10 rounded-md transition-colors"
          >
          ...
          <DownloadOptions
            ...
            fileName={fileName}
            triggerComponent={
              <button className="flex items-center px-2 py-1 text-xs text-slate-900 hover:text-zapier-orange hover:bg-zapier-orange/10 rounded-md transition-colors">
                <FileText className="h-3 w-3 mr-1" />
                Download
              </button>
            }
