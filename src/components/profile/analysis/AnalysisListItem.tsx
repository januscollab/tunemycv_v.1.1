...
const AnalysisListItem: React.FC<AnalysisListItemProps> = ({ 
  ...
  // Format analysis content for download
...
`.trim();
  ...
  const downloadFileName = `CV_Analysis_${analysis.job_title?.replace(/[^a-zA-Z0-9]/g, '_') || 'Report'}_${new Date(analysis.created_at).toISOString().split('T')[0]}`;
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex items-center space-x-3">
          ...
          <DownloadOptions
            ...
            triggerComponent={
              <button className="flex items-center px-3 py-2 text-sm text-purple-600 hover:text-zapier-orange hover:bg-zapier-orange/10 rounded-md transition-colors">
