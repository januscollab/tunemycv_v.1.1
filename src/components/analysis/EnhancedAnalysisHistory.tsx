...
Generated by TuneMyCV - Your AI-Powered Career Assistant`;
  ...
  const handleAnalysisUpdate = (updatedAnalysis: AnalysisHistoryItem) => {
      ...
      <div className="space-y-4">
        {paginatedAnalyses.map((analysis) => (
          <EnhancedAnalysisCard
            key={analysis.id}
            analysis={analysis}
            linkage={linkageCache[analysis.id] || { hasLinkedCoverLetter: false, hasLinkedInterviewPrep: false }}
            onView={handleView}
