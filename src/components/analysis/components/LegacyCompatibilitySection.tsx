  ...
  return (
    <div className="bg-white dark:bg-blueberry/20 rounded-lg shadow p-6 border border-apple-core/20 dark:border-citrus/20">
      <div className="flex items-center mb-4">
        <div className="bg-blue-500 text-white px-3 py-1 rounded text-caption font-medium mr-3">
          Compatibility Breakdown
        </div>
      </div>
      <p className="text-caption text-blueberry/70 dark:text-apple-core/80 mb-4">
      ...
      {result.compatibilityBreakdown.map((category: any, index: number) => (
        <div key={index}>
          <div className="flex items-center justify-between mb-2">
            <span className="font-medium text-blueberry dark:text-citrus text-caption">{category.category}</span>
            <div className="flex items-center space-x-2">
              <span className="text-caption font-bold text-blue-600">{category.score}/10</span>
      ...
      <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
        <div className="flex items-center mb-2">
          <span className="text-caption font-medium text-blue-800 dark:text-blue-300">
            Overall Score: {((result.compatibility_score || result.compatibilityScore) / 10).toFixed(1)}/10
          </span>
        </div>
        <p className="text-micro text-blue-700 dark:text-blue-400">
