        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/next-steps" className="text-muted-foreground hover:text-primary transition-colors">
                  Next Steps
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help-centre" className="text-muted-foreground hover:text-primary transition-colors">
                  Help Centre
                </Link>
              </li>
              <li>
