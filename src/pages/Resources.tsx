...
const Resources = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-cream/50 via-white to-zapier-orange/10 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-earth mb-6 font-display">
            Career Resources
          </h1>
          <p className="text-xl text-earth/80 mb-8">
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full font-medium transition-colors ${
                  selectedCategory === category
                    ...
                    : 'bg-white text-earth border border-border hover:border-zapier-orange hover:text-zapier-orange'
                }`}
              >
                {category}
              </button>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredResources.map((resource, index) => (
              <div key={index} className="bg-white rounded-lg border border-border p-6 hover:border-zapier-orange transition-all hover:shadow-lg">
                <div className="bg-zapier-orange/10 rounded-full w-16 h-16 flex items-center justify-center mb-6">
                  <resource.icon className="h-8 w-8 text-zapier-orange" />
                </div>
                
                <div className="mb-4">
                  <span className="inline-block bg-zapier-orange/10 text-zapier-orange px-3 py-1 rounded-full text-sm font-medium mb-3">
                    {resource.category}
                  </span>
                  <h3 className="text-xl font-semibold text-earth mb-3 font-display">
                    {resource.title}
                  </h3>
                ...
                <a 
                  href={resource.link}
                  className="inline-flex items-center text-zapier-orange font-medium hover:text-zapier-orange/80 transition-colors"
                >
                  Read More →
                </a>
              </div>
      ...
      {/* Newsletter Section */}
      <section className="py-20 px-4 bg-earth text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-white font-display">Stay Updated</h2>
