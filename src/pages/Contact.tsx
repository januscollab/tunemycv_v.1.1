    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-subheading text-blueberry/70 dark:text-apple-core/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-blueberry/90 rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-title font-semibold text-blueberry dark:text-citrus">Email Us</h3>
            </div>
          ...
          <div className="bg-white dark:bg-blueberry/90 rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-title font-semibold text-blueberry dark:text-citrus">Feedback</h3>
            </div>
            <p className="text-blueberry/70 dark:text-apple-core/80 mb-4">
              Use our floating feedback tab on the right to share your thoughts and suggestions.
            </p>
            <p className="text-caption text-blueberry/60 dark:text-apple-core/70">
