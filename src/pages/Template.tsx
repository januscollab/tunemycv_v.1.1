    ...
    <div className="min-h-screen bg-gradient-to-br from-apple-core/15 via-white to-citrus/5 dark:from-blueberry/10 dark:via-gray-900 dark:to-citrus/5 py-6">
      <div className="max-w-wider mx-auto px-4">
        <div className="mb-8">
          ...
          <div className="prose prose-lg max-w-none text-earth/80 dark:text-white/80">
            <p>
            ...
            <h2 className="text-2xl font-bold text-earth dark:text-white mt-8 mb-4">
              Section Header
            </h2>
            ...
            <h3 className="text-xl font-semibold text-earth dark:text-white mt-6 mb-3">
              Subsection
            </h3>
